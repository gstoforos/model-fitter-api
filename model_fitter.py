...
def fit_models():
    ...
    try:
        ...
        add_model("Newtonian", "τ = μ ⋅ γ̇", mu, 1, 0, mu_app, r2, re)
    except Exception as e:
    ...
    try:
        ...
        add_model("Power Law", "τ = K ⋅ γ̇ⁿ", k, n, 0, mu_app, r2, re)
    except Exception as e:
